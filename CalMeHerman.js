...
//KLIK TOMBOL SUBSCRIBE !!!! https://youtube.com/c/alanbotz
//AWAS GA SUBSCRIBE TAR GUE GA UP SC LAGI NI
//MAU GUE ENC?
//KALO MAU YANG NO ENC TERUS KLIK TOMBOL SUBSCRIBE LAH https://youtube.com/c/alanbotz
const {
    WAConnection,
	MessageType,
	Presence,
...
petik = '```'
fake = '©Created By Bellu Ngas'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "Alan Botz️","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `©Alan Botz`,"description": "ItsMeBotz", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "Alan Botz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
╰───────────────🥀
              {              
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Bellu BoTz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTLI dibawah!*`
               ...
               footerText: 'Alan Botz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'Bellu BoTz' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by Alan Botz', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
...
-✎ˀ ${prefix}patrick
-✎ˀ ${prefix}gura
-✎ˀ ${prefix}stickeranime
-✎ˀ ${prefix}semoji* _emoji_
-✎ˀ ${prefix}sticker* _reply foto/video_
-✎ˀ ${prefix}smeme* _teks|teks_
-✎ˀ ${prefix}swm* _pack|author_
-✎ˀ ${prefix}take* _pack|author_
└──» ✎BelluBoTz 。`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
 case 'buttondl':
...
│ˏˋ ☄️ ${prefix}tobc* _audio_
│ˏˋ ☄️ ${prefix}term*
│ˏˋ ☄️ ${prefix}eval*
│ˏˋ ☄️ ${prefix}clearall*
│ˏˋ ☄️ ${prefix}leaveall*
│ˏˋ ☄️ ${prefix}join* _teks_
│ˏˋ ☄️ ${prefix}shutdown*
│ˏˋ ☄️ ${prefix}getquoted*
│ˏˋ ☄️ ${prefix}addupdate* _fiturnya_
│ˏˋ ☄️ ${prefix}exif* _nama|author_
│ˏˋ ☄️ ${prefix}sewa add/del* _waktunya_
│ˏˋ ☄️ ${prefix}premium add* _@tag|nomor_
│ˏˋ ☄️ ${prefix}premium del* _@tag|nomor_
│ˏˋ ☄️ ${prefix}setpp*
│ˏˋ ☄️ ${prefix}setbio*
│ˏˋ ☄️ ${prefix}setname*
│ˏˋ ☄️ ${prefix}getpp*
│ˏˋ ☄️ ${prefix}sharelock*
│ˏˋ ☄️${prefix}chat* _nomor|teks_
╰───────────────🥀`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftext, caption: teksnya })
              break
case 'pricegtivd':
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Alan Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
